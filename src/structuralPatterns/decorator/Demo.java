...
public class Demo {
    ...
    public static void main(String[] args) {
        ...
        class NationalityDecorator implements AbstractComponent{
            ...
            public NationalityDecorator(AbstractComponent decorated,String nationality) {
        ...
        NationalityDecorator nationalityDecorator1 = new NationalityDecorator(component1, "japanese");
